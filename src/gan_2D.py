...
# with tf.GradientTape() as disc_tape_real, tf.GradientTape() as disc_tape_fake, tf.GradientTape() as gen_tape:
#     generated_non_train = generator(noise, training=False)
#     real_output = discriminator(minibatch_X, training=True)
#     fake_output = discriminator(generated_non_train, training=True)
#
...
#     disc_loss_l.append(disc_loss.numpy())
#
#     gradients_of_discriminator_real = disc_tape_real.gradient(real_loss,
#                                                               discriminator.trainable_variables)
#     gradients_of_discriminator_fake = disc_tape_fake.gradient(fake_loss,
#                                                               discriminator.trainable_variables)
#     gradients_of_generator = gen_tape.gradient(gen_loss, generator.trainable_variables)
#
#     discriminator_optimizer.apply_gradients(
#         zip(gradients_of_discriminator_real, discriminator.trainable_variables))
#     discriminator_optimizer.apply_gradients(
#         zip(gradients_of_discriminator_fake, discriminator.trainable_variables))
#     generator_optimizer.apply_gradients(
#         zip(gradients_of_generator, generator.trainable_variables))